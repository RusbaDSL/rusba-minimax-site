-- ==================================================
-- FIXED: RLS Policies and Admin System
...
-- FIX 5: Create a view for easy admin status checking (FIXED COLUMN REFERENCE)
CREATE OR REPLACE VIEW admin_users AS
SELECT 
  u.id,
  u.email,
  p.full_name,              -- FIXED: Use p.full_name instead of u.full_name
...
-- FIX 6: Verify the setup by checking current policies
DO $$
DECLARE
...
-- Success message
SELECT '🎉 Migration completed successfully! Product CRUD operations are now enabled for admins.' as status;